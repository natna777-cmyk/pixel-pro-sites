  ...
  return <section id="contact" className="py-24 relative">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        ...
        duration: 0.5
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Готова помочь вам автоматизировать бизнес-процессы и создать эффективный сайт. Свяжитесь со мной любым удобным способом</p>
        </motion.div>
          ...
          <div className="gradient-border p-8 md:p-12">
            <div className="relative z-10 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <a href="tel:+19168278993" className="flex items-center gap-4 p-6 rounded-xl bg-secondary/50 hover:bg-secondary transition-colors group">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground mb-1">Телефон
Telegram
 WhatsApp</p>
                ...
                <a href="mailto:natna777@gmail.com" className="flex items-center gap-4 p-6 rounded-xl bg-secondary/50 hover:bg-secondary transition-colors group">
